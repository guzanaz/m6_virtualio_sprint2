<template>
  <section id="CreateVM">
    ...
    >
      <b-button href="#" @click="showModal" variant="primary" class="align-self-center ml-0">
        Editar
      </b-button>
    </b-card>
    <b-modal
    ...
    >
      ...
      <b-container fluid="sm">
        <b-row>
          <b-col cols="4" class="bg-primary py-3">
            <b-container>
              <b-row class="mt-3">
                <b-img
                  center
              ...
              >
                ...
                <p class="font-weight-light">
                  Aquí pots modificar la configuració inicial de la teva màquina virtual
                </p>
              </b-row>
            </b-container>
          </b-col>
