                ...
                <div class="col-md-7 d-flex flex-center">
                  <div class="p-4 p-md-5 flex-grow-1">
                    ...
                    <form action="">
                      <div class="mb-3">
                        <label
                          class="d-flex align-items-start form-label"
                          for="card-email"
                          >E-mail</label
                        >
                        <input
                    ...
                    <div class="position-relative my-4">
                      <hr data-content=" o amb" class="bg-300 hr-text" />
                    </div>
                    <div class="mb-3">
                      <button
                        type="button"
                      ...
                      >
                        ...
                        <span class="align-middle px-2">Gmail Log In</span>
                      </button>
                    </div>
                  </div>
                </div>
